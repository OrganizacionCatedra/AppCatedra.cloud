          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              />
               <FormField
                ...
                name="consent"
                render={({ field }) => (
                  <FormItem className="sm:col-span-2 flex flex-row items-start space-x-3 space-y-0 rounded-md border border-input bg-white/5 p-4 dark:bg-black/5">
                    <FormControl>
                      <Checkbox
                        checked={field.value}
            ...
            <div className="flex justify-end pt-4">
              <Button 
                type="submit" 
                size="lg" 
                className="bg-primary text-primary-foreground shadow-lg shadow-primary/20 hover:bg-primary/90 dark:bg-accent dark:text-accent-foreground dark:shadow-accent/20 dark:hover:bg-accent/90"
              >
                Continuar
